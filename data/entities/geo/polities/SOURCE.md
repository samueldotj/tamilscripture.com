...
| Processing | Rows of `Type = POLITY` whose years overlap 4000 BCE – AD 800 and whose geometry meets lon −12…92, lat 5…62 (Europe, the Middle East, Egypt and India). Clipped to that box, simplified to 0.1° (about 11 km) and rounded to 2 decimals. Rows named in brackets, and the `RELATION` rows, are dropped: they repeat the territory of the polities they are composed of. 2,204 rows, 306 polities, 234 distinct years at which something changes. The range runs to AD 800 because the timeline also carries the early church, whose last council is in 787. |
